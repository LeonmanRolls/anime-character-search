...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7569__auto__,writer__7570__auto__,opt__7571__auto__){
return cljs.core._write(writer__7570__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14400 = o;
(G__14400[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6946__auto__ = !((jsprops == null));
if(and__6946__auto__){
var and__6946__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6946__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__6946__auto____$1;
}
} else {
...
var G__14408 = jsprops;
(G__14408["defaultValue"] = value);

(G__14408["onChange"] = ((function (G__14408,v,value,on_change){
return (function (p1__14406_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14406_SHARP_);
});})(G__14408,v,value,on_change))
);
...
var vec__14415 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14415,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14415,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14415,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___14420 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___14420 == null)){
} else {
var key_14421 = temp__4661__auto___14420;
(jsprops["key"] = key_14421);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14423 = (new reagent.impl.template.NativeWrapper());
(G__14423["name"] = c);
...
var G__14425 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14425) : reagent.impl.template.as_element.call(null,G__14425));
} else {
...
var len__8071__auto___14431 = arguments.length;
var i__8072__auto___14432 = (0);
while(true){
if((i__8072__auto___14432 < len__8071__auto___14431)){
args__8078__auto__.push((arguments[i__8072__auto___14432]));

var G__14433 = (i__8072__auto___14432 + (1));
i__8072__auto___14432 = G__14433;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8079__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14429){
var G__14430 = cljs.core.first(seq14429);
var seq14429__$1 = cljs.core.next(seq14429);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14430,seq14429__$1);
});
...
break;
default:
var G__14437 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14437;
continue;
...
var n__7881__auto___14440 = a.length;
var i_14441 = (0);
while(true){
if((i_14441 < n__7881__auto___14440)){
(a[i_14441] = reagent.impl.template.as_element((a[i_14441])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7881__auto___14443 = a.length;
var i_14444 = (0);
while(true){
if((i_14444 < n__7881__auto___14443)){
var val_14445 = (a[i_14444]);
if((cljs.core.vector_QMARK_(val_14445)) && ((reagent.impl.template.key_from_vec(val_14445) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14444] = reagent.impl.template.as_element(val_14445));
...
var ctx = ({});
var vec__14450 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14450,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14450,(1),null);
...
var G__14454 = (cljs.core.count(argv) - first_child);
switch (G__14454) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14454){
